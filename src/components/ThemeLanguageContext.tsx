...
const translations = {
  es: {
    ...
    // SCC Supply Chain
    'scc.title': 'Cadena de Suministro SCC',
    'scc.uocsTab': 'Unidades (UoCs)',
    'scc.dashboardTab': 'Tablero de Control',
    'scc.receptionTab': 'Recepción',
    'scc.productionTab': 'Producción',
    'scc.salesTab': 'Ventas',
    'scc.stockTab': 'Inventarios',
    'scc.newUoc': '+ Nueva UoC',
    'scc.newTx': '+ Nueva Transacción',
    'scc.configScope': '⚙ Configurar Alcance',
    'scc.appliesAll100': '✓ Aplica 100% (M1-M7)',
    'scc.customScope': '⚙ Alcance Personalizado',
    'scc.thName': 'Nombre UoC',
    'scc.thCompany': 'Empresa / Razón Social',
    'scc.thType': 'Tipo de Unidad',
    'scc.thArea': 'Área (ha)',
    'scc.thScope': 'Alcance RSPO',
    'scc.thActions': 'Acciones',
    'scc.uocCount': 'Unidades Registradas',
    'scc.totalVol': 'Volumen Procesado (TM)',
    'scc.stockBalance': 'Balance de Inventario',

    // Stakeholders
    'sh.title': 'Gestión de Partes Interesadas',
    'sh.matrixTab': 'Matriz de Diálogo Social',
    'sh.grievanceTab': 'Mecanismo de Quejas y Reclamos (M1)',
    'sh.fpicTab': 'Consulta FPIC / CLPI (M4)',
    'sh.newStakeholder': '+ Nueva Parte Interesada',
    'sh.newGrievance': '+ Registrar Queja',
    'sh.totalStakeholders': 'Partes Registradas',
    'sh.highImpact': 'Alto Impacto',
    'sh.openGrievances': 'Quejas Abiertas',
    'sh.fpicConsultations': 'Consultas FPIC',

    // Alerts
    'alerts.title': 'Sistema de Alertas y Notificaciones',
    ...
    'alerts.immediateAction': 'Acción inmediata',
    'alerts.promptAttention': 'Atención pronta',
    'alerts.notDismissed': 'Sin descartar',

    // Plant Extractora
    'plant.title': 'P&C Planta Extractora',
    'plant.verification': 'Verificación',
    'plant.activeControls': 'Controles Activos',
    'plant.attention': 'Atención',
    'plant.responsibles': 'Responsables',
    'plant.naBannerTitle': 'Alcance N/A para esta Unidad de Certificación',
    'plant.naBannerDesc': 'La UoC seleccionada es de tipo Solo Plantación / Finca. Las operaciones industriales de refinación y laboratorio aplican N/A.',

    // Plantation Compliance
    'plantations.title': 'Cumplimiento Agrícola',
    'plantations.count': 'Plantaciones',
    'plantations.avgCompliance': 'Cumplimiento Promedio',
    'plantations.criticalIssues': 'Asuntos Críticos',
    'plantations.atRisk': 'En Riesgo',
    'plantations.naBannerTitle': 'Alcance N/A para esta Unidad de Certificación',
    'plantations.naBannerDesc': 'La UoC seleccionada es de tipo Solo Planta Extractora. Las labores agronómicas de campo se administran en sus UoCs proveedoras.',

    // GHG Calculator
    'ghg.title': 'Calculadora GHG / PalmGHG',
    'ghg.grossEmissions': 'Emisiones Brutas',
    'ghg.credits': 'Créditos / Capturas',
    'ghg.netEmissions': 'Emisiones Netas',
    'ghg.cpoIntensity': 'Intensidad CPO',
    'ghg.rffIntensity': 'Intensidad RFF',
    'ghg.sourcesTitle': 'Fuentes de Emisión (tCO2e)',
    'ghg.creditsTitle': 'Capturas y Créditos (tCO2e)',

    // Supply Base
    'supply.title': 'Base de Suministro',
    'supply.registeredSuppliers': 'Proveedores Registrados',
    'supply.totalArea': 'Área Total (ha)',
    'supply.highRisk': 'Riesgo Alto',
    'supply.eligible': 'Elegibles RSPO',
    'supply.newSupplier': '+ Nuevo Proveedor',
  },
  en: {
    // Navigation & Page Titles
    ...
    // SCC Supply Chain
    'scc.title': 'SCC Supply Chain',
    'scc.uocsTab': 'Units (UoCs)',
    'scc.dashboardTab': 'Control Dashboard',
    'scc.receptionTab': 'Reception',
    'scc.productionTab': 'Production',
    'scc.salesTab': 'Sales',
    'scc.stockTab': 'Inventory',
    'scc.newUoc': '+ New UoC',
    'scc.newTx': '+ New Transaction',
    'scc.configScope': '⚙ Configure Scope',
    'scc.appliesAll100': '✓ Applies 100% (M1-M7)',
    'scc.customScope': '⚙ Custom Scope',
    'scc.thName': 'UoC Name',
    'scc.thCompany': 'Company / Legal Entity',
    'scc.thType': 'Unit Type',
    'scc.thArea': 'Area (ha)',
    'scc.thScope': 'RSPO Scope',
    'scc.thActions': 'Actions',
    'scc.uocCount': 'Registered Units',
    'scc.totalVol': 'Processed Volume (MT)',
    'scc.stockBalance': 'Inventory Balance',

    // Stakeholders
    'sh.title': 'Stakeholder Management',
    'sh.matrixTab': 'Social Dialogue Matrix',
    'sh.grievanceTab': 'Grievance Mechanism (M1)',
    'sh.fpicTab': 'FPIC Consultation (M4)',
    'sh.newStakeholder': '+ New Stakeholder',
    'sh.newGrievance': '+ Log Grievance',
    'sh.totalStakeholders': 'Registered Stakeholders',
    'sh.highImpact': 'High Impact',
    'sh.openGrievances': 'Open Grievances',
    'sh.fpicConsultations': 'FPIC Consultations',

    // Alerts
    'alerts.title': 'Alerts & Notifications System',
    ...
    'alerts.immediateAction': 'Immediate action',
    'alerts.promptAttention': 'Prompt attention',
    'alerts.notDismissed': 'Not dismissed',

    // Plant Extractora
    'plant.title': 'P&C Processing Mill',
    'plant.verification': 'Verification',
    'plant.activeControls': 'Active Controls',
    'plant.attention': 'Attention',
    'plant.responsibles': 'Assigned Managers',
    'plant.naBannerTitle': 'Scope N/A for this Certification Unit',
    'plant.naBannerDesc': 'Selected UoC is Plantation / Farm only. Industrial refining and lab operations apply N/A.',

    // Plantation Compliance
    'plantations.title': 'Plantation Compliance',
    'plantations.count': 'Plantations',
    'plantations.avgCompliance': 'Average Compliance',
    'plantations.criticalIssues': 'Critical Issues',
    'plantations.atRisk': 'At Risk',
    'plantations.naBannerTitle': 'Scope N/A for this Certification Unit',
    'plantations.naBannerDesc': 'Selected UoC is Mill Only. Agronomic field operations are managed in supplying farm UoCs.',

    // GHG Calculator
    'ghg.title': 'GHG / PalmGHG Calculator',
    'ghg.grossEmissions': 'Gross Emissions',
    'ghg.credits': 'Credits / Offsets',
    'ghg.netEmissions': 'Net Emissions',
    'ghg.cpoIntensity': 'CPO Intensity',
    'ghg.rffIntensity': 'FFB Intensity',
    'ghg.sourcesTitle': 'Emissions Sources (tCO2e)',
    'ghg.creditsTitle': 'Offsets & Credits (tCO2e)',

    // Supply Base
    'supply.title': 'Supply Base',
    'supply.registeredSuppliers': 'Registered Suppliers',
    'supply.totalArea': 'Total Area (ha)',
    'supply.highRisk': 'High Risk',
    'supply.eligible': 'RSPO Eligible',
